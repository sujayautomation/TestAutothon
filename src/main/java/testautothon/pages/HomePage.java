...
import testautothon.utils.TcUtils;
    ...
    private String getMovieWikiUrl(String movieName) {
        ...
        try {
            ...
            for (WebElement itm : movieWikiHeader) {
                if ((TcUtils.getParentElement(itm, 1).getAttribute("href").startsWith("https://en.wikipedia.org"))) {
                    movieWikiUrl = TcUtils.getParentElement(itm, 1).getAttribute("href");
                    break;
                }
            }
